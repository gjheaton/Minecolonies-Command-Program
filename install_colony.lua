...
local SUITE_INFO = {
    suiteVersion = "1.1.23",
    installerVersion = "1.1.23",
    apps = {
        command = { version = "2.15", program = "/colony_command.lua", displayName = "MineColonies Command Center" },
        supply = { version = "2.58", program = "/colony_supply.lua", displayName = "MineColonies Supply Manager" },
    },
    components = {
        startup = "1.0.0", util = "1.1.0", ui = "1.1.0",
        version = "1.0.0", updater = "1.1.1", installer = "1.1.23",
    },
}
