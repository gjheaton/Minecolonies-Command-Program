...
local SUITE_INFO = {
    suiteVersion = "1.1.8",
    installerVersion = "1.1.8",
    apps = {
        command = { version = "2.14", program = "/colony_command.lua", displayName = "MineColonies Command Center" },
        supply = { version = "2.43", program = "/colony_supply.lua", displayName = "MineColonies Supply Manager" },
    },
    components = {
        startup = "1.0.0", util = "1.0.1", ui = "1.0.0",
        version = "1.0.0", updater = "1.1.0", installer = "1.1.8",
    },
}
