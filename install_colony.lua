...
local SUITE_INFO = {
    ...
    apps = {
        ...
        supply = { version = "2.60", program = "/colony_supply.lua", displayName = "MineColonies Supply Manager" },
    },
    components = {
        startup = "1.0.0", util = "1.1.0", ui = "1.1.0",
        version = "1.0.0", updater = "1.1.1", installer = "1.1.25",
    },
}
